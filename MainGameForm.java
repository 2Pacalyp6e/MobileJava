...
public class MainGameForm extends JPanel {
    private static MainGameForm instance = null;

    public static final int FIELD_SIZE = 555;
    ...
    public static synchronized MainGameForm getInstance() {
        if (instance == null)
            instance = new MainGameForm();
        return instance;
    }
    ...
    private MainGameForm() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                x = e.getX() / cellSize;
                y = e.getY() / cellSize;
                System.out.println("Кликнули " + e.getX() + " " + e.getY());
    ...
    void modeAgainstAI() {
        ...
        if (!gameOver) {
            if (player.shot(x, y)) {
                ...
                if (ai.win()) {
                    System.out.println("Алиса Победила!!!");
                    gameOver = true;
                    gameOverMessage = "Алиса Победила!!!";
                }
                repaint();
